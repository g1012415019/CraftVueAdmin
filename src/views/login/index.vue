...
<style lang="less" scoped>
  .view-account {
    ...
    .social-icon {
      ...
      &:hover {
        background-color: rgb(45 140 240 / 20%);
        transform: scale(1.1);
    ...
    .login-input {
      ...
      &:hover {
        :deep(.n-input-wrapper) {
          box-shadow: 0 0 0 1px rgb(45 140 240 / 20%);
        }
      }
    }
  ...
  @media (min-width: 768px) {
    .view-account {
      background-image: url('../../assets/images/login.svg'),
        radial-gradient(
          circle at 10% 20%,
          rgb(100 149 237 / 25%) 0%,
          rgb(65 105 225 / 20%) 40%,
          rgb(30 144 255 / 10%) 90%
        );
      ...
      &::before {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(135deg, rgb(45 140 240 / 10%), rgb(45 140 240 / 5%));
        backdrop-filter: blur(10px);
        z-index: 0;
      }
  ...
  .view-account-background {
    ...
    .line {
      position: absolute;
      background: linear-gradient(90deg, rgb(45 140 240 / 20%), rgb(0 129 255 / 10%));
    ...
    .square {
      ...
      &-1 {
        ...
        top: 10%;
        left: 15%;
        background: linear-gradient(45deg, rgb(45 140 240 / 15%), rgb(0 129 255 / 5%));
        transform: rotate(30deg);
      ...
      &-2 {
        ...
        bottom: 15%;
        right: 10%;
        border: 2px solid rgb(45 140 240 / 10%);
    ...
    .triangle {
      ...
      border-bottom: 80px solid rgb(45 140 240 / 8%);
